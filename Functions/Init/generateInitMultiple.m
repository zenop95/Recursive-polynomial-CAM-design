...
secondary = struct();
absState = [6776.628    -1440.512	-2817.917	 6890.038	-2817.863;
           -866.8422	 4078.249	 3808.916	-435.8675	-3808.910;
           -1150.571	 5412.035	 5054.62	-578.2995	-5054.577;
           -1.208085	  3.483201	6.777967	-0.137679	 6.590243;
           -8.314340	 -4.903132	-0.556641	 5.177411	 0.1061327;
            0.604883	  4.621828	3.359167	-5.541674   -3.753949];
...
%     secondary(j).x0       = xBall(:,conj_id(j)) - dx;         
    ...
    secondary(j).C0       = [[B(conj_id(j),21) B(conj_id(j),24) B(conj_id(j),25);
                             ...
                             B(conj_id(j),25) B(conj_id(j),26) B(conj_id(j),23)] zeros(3,3); zeros(3,6)];
