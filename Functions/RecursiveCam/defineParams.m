function pp = defineParams(pp,fireTimes,returnTime)
...
pp.PoCLim        = 1e-6;                                                        % [-]      (1,1) PoC limit for each conjunction
...
pp.flagMd           = 1;                                                        % [bool]   (1,1) Miss distance instead of PoC
...
pp.flagMeanSma      = 1;                                                        % [bool]   (1,1) Toggle Mean Orbital Elements Station-keeping constraints
