...
pseudoH = DAArrays{2};                                                          % [-] (n,n) Initialize Hessian with 2nd-order
for j = 3:k
...
gradPs    = grad + deltaGrad;                                                   % [-] (1,n) Pseudo-gradient
gradUnit  = normalize(gradPs,'norm');                                           % [-] (1,n) Pseudo-gradient direction
gradNorm  = norm(gradPs);                                                       % [-] (1,1) Pseudo-gradient norm
